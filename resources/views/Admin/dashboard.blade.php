                        ...
                        <div class="flex">
                            <div
                                ...
                                <div class="relative p-8 md:p-12">
                                    <h5 class="text-2xl text-white uppercase mb-2">Welcome</h5>
                                    <h4 class="text-2xl text-primary font-semibold mb-4">Triumph Anya-Nga</h4>
                                    <p class="text-base text-white mb-6 max-w-lg">Overview of my portfolio</p>
                                    <a href="#"
                            ...
                            <div class="grid lg:grid-cols-4 grid-cols-2 gap-6">
                                ...
                                <a href="product-grid.html"
                                    ...
                                    <div class="relative rounded-lg overflow-hidden divide-y divide-default-200">
                                        ...
                                        <div class="pt-2">
                                            <h4 class="text-default-800 text-xl font-semibold line-clamp-1 mb-2">
                                                Noodles
                                            </h4>
                                ...
                                <a href="product-grid.html"
                                    ...
                                    <div class="relative rounded-lg overflow-hidden divide-y divide-default-200">
                                        ...
                                        <div class="pt-2">
                                            <h4 class="text-default-800 text-xl font-semibold line-clamp-1 mb-2">Red
                                                Velvet
                                                Pastry</h4>
                                            <h6 class="font-semibold text-lg text-default-500">$25.14</h6>
                                        </div>
